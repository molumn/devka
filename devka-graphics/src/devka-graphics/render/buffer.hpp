...
namespace dvk::graphics {
        ...
        static uint32 ShaderDataTypeSize(ShaderDataType type) {
            ...
            DK_ASSERT(false, DK_GRAPHIC_LOG_CODE, "No such element[ShaderDataType, {0}] <-- file: {1}, line: {2}", (int32)type);
            return 0;
        }
...
#define EMPTY_BUFFER_LAYOUT     dvk::graphics::BufferLayout()
        ...
        struct VertexBufferParam {
            ...
            VertexBufferParam(f32* vertexes, uint32 size, uint32 VBO, BufferLayout layout = EMPTY_BUFFER_LAYOUT)
